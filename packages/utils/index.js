...
import * as strUtils from "@jsyg/strutils";
import $ from "jquery";
    
const svg = JSYG.support.svg;
...
JSYG.getStyleRules = function() {
    ...
    Array.from(document.styleSheets).forEach(function(styleSheet) {
        ...
        Array.from(styleSheet.cssRules).forEach(addStyle);
    });
    ...
    return function(method) {
        ...
        this.each(function() {
            ...
            if (method == 'get') {
                ...
                if (method.slice(0,1) === '_')	throw new Error("La méthode " +  method + " est privée.");
...
for (const key in strUtils) JSYG[key] = strUtils[key];
