...
style.innerHTML = /*css*/ `svg g.fillBox path {
	fill:black;
	fill-opacity:0.1;
	stroke:black;
	stroke-width:0.5;
 ...
 */
export default function BoundingBox(arg,opt) {
...
let boundingBox = JSYG.bindPlugin(BoundingBox);
/**
